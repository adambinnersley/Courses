...
<div class="row">
    <div class="col-lg-6 mx-auto">
        <div class="card border-danger">
            <div class="card-header bg-danger">Remove pupil from this course?</div>
            <div class="card-body">
                <h4 class="text-center">Confirm Pupil Removal</h4>
                <p class="text-center">Are you sure you wish to remove the pupil <strong>{$pupil.name}</strong> from this course?</p>
