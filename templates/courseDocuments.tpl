...
<div class="row">
    ...
    <div class="col-12">
        {if $userDetails.isHeadOffice && !$add && !$delete && !$smarty.get.editgroup && !$smarty.get.deletegroup}<div class="row"><div class="col-12"><a href="/student/learning/{$courseInfo.url}/course-documents/add" title="Add new item" class="btn btn-success float-right"><span class="fa fa-plus fa-fw"></span> Add new document</a></div></div>{/if}
                <a href="/student/learning/{$courseInfo.url}/{if !$add && !$edit && !$delete && !$smarty.get.editgroup && !$smarty.get.deletegroup}{else}course-documents/{/if}" title="Back to {if !$add && !$edit && !$delete && !$smarty.get.editgroup && !$smarty.get.deletegroup}course home{else}documents{/if}" class="btn btn-danger">&laquo; Back to {if !$add && !$edit && !$delete && !$smarty.get.editgroup && !$smarty.get.deletegroup}course home{else}documents{/if}</a>
