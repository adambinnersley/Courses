...
<div class="row">
    ...
    <div class="col-12">
        ...
        {elseif $delete}
            ...
            <div class="text-center">
            <form method="post" action="" class="form-inline">
                <a href="course-documents" title="No, return to documents" class="btn btn-success">No, return to documents</a> &nbsp; 
