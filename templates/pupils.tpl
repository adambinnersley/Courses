...
<div class="row" id="course-list">
    ...
    {if $userDetails.isHeadOffice && !$add && !$delete}<div class="col-lg-12"><a href="info?addnew=true" title="Add new pupil" class="btn btn-success pull-right"><span class="fa fa-plus fa-fw"></span> Add new pupil</a></div>{/if}
