...
<div class="card border-primary">
    <div class="card-header bg-primary">Add Document Group</div>
    <div class="card-body">
        <form method="post" action="" class="form-horizontal">
            ...
            <div class="form-group row">
                <div class="col-md-9 col-md-offset-3"><label class="sr-only" for="submitbtn">Submit</label><input name="submitbtn" id="submitbtn" class="btn btn-success btn-block" type="submit" value="Add Group" /></div>
            </div>
        </form>
    </div>
</div>
