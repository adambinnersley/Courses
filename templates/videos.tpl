...
<div class="row" id="course-list">
    ...
    {if $userDetails.isHeadOffice && !$add && !$delete}<a href="videos?addnew=true" title="Add new item" class="btn btn-success float-right"><span class="fa fa-plus fa-fw"></span> Add new video</a>{/if}
    {if $add || $edit}
